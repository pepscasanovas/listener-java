...
public class MqttToken implements IMqttToken {
	/**
	 * A reference to the the class that provides most of the implementation of
	 * the MqttToken. MQTT application programs must not use the internal class.
	 */
	...
	public void setActionCallback(IMqttActionListener connectActionListener) {
		internalTok.setActionCallback(connectActionListener);
