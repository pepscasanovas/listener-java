...
/**
 * Utility to help debug problems with the Paho MQTT client Once initialised a
 * call to dumpClientDebug will force any memory trace together with pertinent
 * client and system state to the main log facility.
 * 
 * No client wide lock is taken when the dump is progress. This means the set of
 * client state may not be consistent as the client can still be processing work
...
public class Debug {
	 ...
	 * 
	 * @param clientID
	 *            the ID of the client being debugged
	 * @param comms
	 *            the ClientComms object of the client being debugged
	 */
	...
	/**
	 * Dump maximum debug info. This includes state specific to a client as well
	 * as debug that is JVM wide like trace and system properties. All state is
	 * written as debug log entries.
	 */
	...
	/**
	 * Dump of JVM wide debug info. This includes trace and system properties.
	...
	/**
	 * If memory trace is being used a request is made to push it to the target
	 * handler.
	 */
