 ...
 * implementation is compatible with all Java SE runtimes from 1.4.2 and up.
 * </p>
 * <p>
 ...
 * true it is safe to use memory persistence as all state it cleared when a
...
public class MqttClient implements IMqttClient { // ), DestinationProvider {
	 ...
	 * 
	 * @see
	 * org.eclipse.paho.client.mqttv3.IMqttClient#subscribe(java.lang.String,
	 ...
	 *            before the action times out. A value or 0 or -1 will wait
	 ...
	 * 
	 * @see
	 * org.eclipse.paho.client.mqttv3.IMqttClient#getPendingDeliveryTokens()
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.paho.client.mqttv3.IMqttClient#getTopic(java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.paho.client.mqttv3.IMqttClient#setCallback(org.eclipse.paho.
	 * client.mqttv3.MqttCallback)
	 */
