 ...
 *			}
 *		  });
 *      </pre></code> An optional context object can be passed into the method
 * which will then be made available in the callback. The context is stored by
 * the MQTT client) in the token which is then returned to the invoker. The
 * token is provided to the callback methods where the context can then be
 * accessed.
 * </p>
 * </li>
 * </ol>
...
public interface IMqttAsyncClient {
	 ...
	 * false and is set to false the next time a connection is made QoS 1 and 2
	 * messages that were not previously delivered will be delivered.
	 * </p>
	 * <p>
	 ...
	 * <samp class="codeph">\x0000</samp>) in any topic.</li>
	 * </ul>
	 *
	 * <p>
