...
public class WebSocketSecureNetworkModule extends SSLNetworkModule {
	...
	/**
	 * Overrides the flush method. This allows us to encode the MQTT payload
	 * into a WebSocket Frame before passing it through to the real socket.
	 */
	...
	public void start() throws IOException, MqttException {
		super.start();
		WebSocketHandshake handshake = new WebSocketHandshake(super.getInputStream(), super.getOutputStream(), uri,
				host, port);
		handshake.execute();
