...
/**
 * A Logger object is used to send log and trace messages to a platform specific
 * logging implementation. Loggers are named, using a hierarchical dot-separated
 * name-space. Logger names can be arbitrary strings, but they should normally
 * be based on the component or the package name of the logged component
 * 
...
public interface Logger {
	...
	/**
	 * Set a name that can be used to provide context with each log record. This
	 * overrides the value passed in on initialise
	 */
